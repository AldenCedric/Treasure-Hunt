  ...
  return (
    <div className={`min-h-screen w-full bg-gradient-to-br from-sky-400 to-sky-600 flex items-center justify-center p-4 relative overflow-hidden ${
      ...
      <div className="relative w-full max-w-7xl" ref={containerRef}>
            ...
            {editPlacements && selectedMarker && (
              <div
                ...
                <div className="relative">
                  <div className="w-12 h-12 border-4 border-yellow-400 rounded-full animate-pulse" />
                  <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-yellow-400 text-black px-2 py-1 rounded text-xs font-bold whitespace-nowrap">
                    Selected: {selectedPlacementId}
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="absolute top-20 left-4 z-30 bg-gray-900/80 text-white px-4 py-2 rounded-lg border-2 border-gray-700 text-xs font-mono">
